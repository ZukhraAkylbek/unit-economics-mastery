...
import { Users, Coins, TrendingUp, Plus, Search, Edit2, Check, X, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">Добавляйте и редактируйте данные студентов</p>
      </div>
